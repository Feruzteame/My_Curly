...
const Public = () => {
  ...
  return (
    <div className='flex flex-col gap-0' >
      ...
      <Hero />
      <div className='p-20'>
        <p className='text-4xl font-bold py-10 text-[#ff583e]'>How it works ?</p>
        <div className="flex items-center justify-center gap-10 h-[300px]">
          <div className="flex flex-col justify-center items-center bg-gray-300 py-10 px-4 h-full w-full shadow-md shadow-gray-500 rounded">
            <p className='flex items-center justify-center text-xl font-bold p-2 bg-black text-white w-12 h-12 rounded-full'>1</p>
            <p className='text-xl font-bold p-6' >DISCOVER OUR SERVICES</p>
            <p>First discover we recommended our work and service.</p>
          </div>
          <div className="flex flex-col justify-center items-center bg-gray-300 py-10 px-4 h-full w-full shadow-md shadow-gray-500 rounded">
            <p className='flex items-center justify-center text-xl font-bold p-2 bg-black text-white w-12 h-12 rounded-full'>2</p>
            <p className='text-xl font-bold p-6' >GET TO KNOW YOU</p>
            <p>Fill the service request to understand you hair</p>
          </div>
          <div className="flex flex-col justify-center items-center bg-gray-300 py-10 px-4 h-full w-full shadow-md shadow-gray-500 rounded">
            <p className='flex items-center justify-center text-xl font-bold p-2 bg-black text-white w-12 h-12 rounded-full'>3</p>
      ...
      <div className='flex items-center justify-center gap-10 px-20 py-10'>
        <div className="relative w-[500px] h-[300px] border border-black shadow-lg shadow-gray-500">
          <video
          ...
          <div className="relative z-10 flex items-end justify-center w-full h-full p-4">
            <h1 className="text-4xl font-bold">Request to our services</h1>
          </div>
        </div>
        <div className='w-[50%] flex flex-col gap-4'>
          ...
          <button className='bg-black text-white px-8 py-4 mt-10 rounded w-auto'>Request Here</button>
        </div>
      </div>
      <Footer />
    </div>
