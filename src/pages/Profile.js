                ...
                <div className='p-4'>
                        ...
                        <li key={index}>
                          <div className='flex items-center gap-4'>
                            ...
                            **** **** **** {card.cardNumber.slice(-4)}
                            <img src={Delete} alt='delete' onClick={handleDeleteCard} className='w-5 h-5 transition duration-300 transform hover:scale-125' />
                          </div>
                        </li>
                      ))}
                    </ul>
                  ...
                  <form onSubmit={handleFormSubmit}>
                    ...
                    <div className='flex flex-col-reverse'>
                      <input required type='text' value={cardholderName} onChange={(e) => setCardholderName(e.target.value)} className='m-3 p-2 lg:w-[350px] w-[90%] rounded' />
                      <label>Cardholder's Name</label>
                    </div>
                    <div className='flex flex-col-reverse'>
                      <input required type='text' value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} className='m-3 p-2 lg:w-[350px] w-[90%] rounded' />
                      <label>Card Number</label>
                    </div>
                    <div className='flex flex-col-reverse'>
                      <input id='form5' required type='text' value={expirationDate} onChange={(e) => setExpirationDate(e.target.value)} placeholder='MM/YYYY' className='m-3 p-2 lg:w-[350px] w-[90%] rounded' />
                      <label>Expire Date</label>
                    </div>
                    <div className='flex flex-col-reverse'>
                      <input id='form6' required type='password' value={cvv} onChange={(e) => setCVV(e.target.value)} placeholder='CVV' className='m-3 p-2 lg:w-[350px] w-[90%] rounded' />
                      <label>CVV</label>
                    </div>
