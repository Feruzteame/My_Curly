    ...
    <nav className="w-full z-10">
      <div className="max-w-7xl mx-auto px-10 py-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex gap-2">
          <Link to="/" className="text-black hover:underline decoration-[#ff583e] decoration-2 mr-4">
            Home
          </Link>
          <Link to="/about" className="text-black hover:underline decoration-[#ff583e] decoration-2 mr-4">
            About
          </Link>
          <Link to="/product" className="text-black hover:underline decoration-[#ff583e] decoration-2 mr-4">
            Our Product
          </Link>
          <Link to="/contact" className="text-black hover:underline decoration-[#ff583e] decoration-2">
            Contact Us
          </Link>
          {isAuthenticated && (
            <Link to="/profile" className="text-black hover:underline decoration-[#ff583e] decoration-2 ml-4">
              My Account
            </Link>
          )}
        </div>
      ...
      {/* Mobile menu */}
      <div
        className={`fixed top-20 left-0 w-full h-auto bg-[#ff583e] text-white overflow-y-auto transition-transform duration-1000 ease-in-out ${
      ...
      >
        <div className="max-w-7xl mx-auto lg:px-8">
          <div className="flex flex-col justify-center items-center">
            ...
            <div className='w-full bg-white flex justify-center items-center gap-10 p-2 text-lg border-[#ea3d22b1] border-b-2 px-10'>
              {isAuthenticated && (
