  ...
  return (
    <div>
      <div className="flex flex-col gap-10">
        <h1 className='overline decoration-[#ff583e] decoration-2 text-3xl text-center'>Testimonial</h1>
        <p className='text-center text-neutral-500 italic text-md'>What people say about us ?</p>
      </div>
            ...
            {Testimonial_data.map((item) => (
              <div key={item.id} className='flex justify-center items-center h-auto m-20'>
                <div className='relative flex flex-col justify-center items-center w-[500px] h-[300px]'>
                  <img src={item.image} alt={'person' + item.id} className='absolute top-[-10%] h-24 w-24 rounded-full border-2 border-solid border-black z-20' ></img>
                  <div className=" bg-white rounded-lg overflow-hidden shadow-2xl shadow-[gray] border-2 border-solid border-black h-auto w-auto">
